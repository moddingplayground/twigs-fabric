...
public class BambooLeavesBlock extends PlantBlock implements Waterloggable {
    ...
    public static final VoxelShape SHAPE_ONE = createCuboidShape(0, 0, 0, 16, 1, 16);
    public static final VoxelShape SHAPE_TWO = createCuboidShape(0, 0, 0, 16, 2, 16);
    public static final VoxelShape SHAPE_THREE = createCuboidShape(0, 0, 0, 16, 3, 16);
    public static final VoxelShape SHAPE_FOUR = createCuboidShape(0, 0, 0, 16, 5, 16);
