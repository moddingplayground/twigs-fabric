...
public class TwigsConfiguredFeatures {
    public static final ConfiguredFeature<?, ?> PATCH_TWIG = register("patch_twig", Feature.RANDOM_PATCH.configure(randomPatch(BlockStateProvider.of(States.TWIG), 3)));
    public static final ConfiguredFeature<?, ?> PATCH_PEBBLE = register("patch_pebble", Feature.RANDOM_PATCH.configure(randomPatch(BlockStateProvider.of(States.PEBBLE), 2)));

    public static final ConfiguredFeature<?, ?> ORE_RHYOLITE = register("ore_rhyolite", Feature.ORE.configure(new OreFeatureConfig(BASE_STONE_OVERWORLD, States.RHYOLITE, 45)));
    public static final ConfiguredFeature<?, ?> ORE_SCHIST = register("ore_schist", Feature.ORE.configure(new OreFeatureConfig(BASE_STONE_OVERWORLD, States.SCHIST, 64)));
    public static final ConfiguredFeature<?, ?> ORE_BLOODSTONE = register("ore_bloodstone", Feature.ORE.configure(new OreFeatureConfig(BASE_STONE_NETHER, States.BLOODSTONE, 64)));
